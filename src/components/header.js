                            ...
                            <div className="max-w-4xl mx-auto px-2 sm:px-4 py-2">
                                <div className="relative flex items-center justify-between h-16">
                                    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                                        {/* Mobile menu button*/}
                                        <Disclosure.Button
                                            className="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-primary-copy hover:bg-primary-lightest focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary">
                                    ...
                                    <div
                                        ...
                                        <div className="flex-shrink-0 flex items-center">
                                            <Link to="/">
                                                {entry.slug !== 'home' &&
                                                <p className="text-xl sm:text-3xl font-bold">Matt Banner</p>}
                                            </Link>
                                        </div>
